...
const showMenu = (type, xLocation, yLocation) => {
  ...
  if (type == "quality") {
    ...
    <tbody>
    <tr>
    <td><span>Framerate</span><span style="color: #1c1e20">_</span></td>
    <td>
    <select name="cars" id="cars" class="quality-selector menu-component">
      <option value="volvo">5 FPS</option>
      <option value="volvo">15 FPS</option>
      <option value="saab">20 FPS</option>
      <option value="opel">30 FPS</option>
      <option value="audi">60 FPS</option>
      <option value="audi">Unlimited</option>
    </select>
    </div>
    </td>
    </tr>
    ...
    <td>
    <select name="cars" id="cars" class="quality-selector menu-component">
      <option value="volvo">120p</option>
      <option value="volvo">240p</option>
      <option value="saab">360p</option>
      <option value="opel">420p</option>
      <option value="audi">1080p</option>
      <option value="audi">Unlimited</option>
    </select>
    </td>
    </tr>
...
const closeMenu = (e) => {
  var condition = true
  if($(e.target).hasClass('menu-component')){
    condition = false;
  }
  const contextMenu = document.getElementById("stevenmeeting-menu");
  const menuBar = document.getElementById("menu-bar");
  if(e != ""){
    if (!contextMenu.matches(':hover') && !menuBar.matches(':hover') && condition) {
